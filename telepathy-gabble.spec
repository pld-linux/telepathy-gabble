...
%attr(755,root,root) %{_libdir}/telepathy/gabble-0/lib/libgabble-plugins-0.16.0.so
%attr(755,root,root) %{_libdir}/telepathy/gabble-0/lib/libgabble-plugins.so
%attr(755,root,root) %{_libdir}/telepathy/gabble-0/lib/libwocky-telepathy-gabble-0.16.0.so
